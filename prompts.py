...
IMPORTANT: If the user's question is not about music, artists, songs, or albums, call the reroute tool with a choice of any one of these routes - ["customer", "music", "invoice", "refund"] - that best matches their query.
"""
...
IMPORTANT: If the user's question is not about viewing or updating customer profile information, call the reroute tool with a choice of any one of these routes - ["customer", "music", "invoice", "refund"] - that best matches their query.
...
1. For VIEWING information:
   ...
   - Check if the employee's request includes a specific customer ID.
    ...
    - A request to view might include phrases like "show me", "profile", "information", "view"
...
IMPORTANT: If the user's question is not about viewing invoice information, call the reroute tool with a choice of any one of these routes - ["customer", "music", "invoice", "refund"] - that best matches their query.
...
IMPORTANT: If the user's question is not about refunds, call the reroute tool with a choice of any one of these routes - ["customer", "music", "invoice", "refund"] - that best matches their query.
...
IMPORTANT: If the user's question is not about processing refunds, call the reroute tool with a choice of any one of these routes - ["customer", "music", "invoice", "refund"] - that best matches their query.
